...
```
Learnt from: Scyye
URL: https://github.com/Scyye/ZanyArtifacts/issues/3

Timestamp: 2026-04-17T03:15:36.771Z
Learning: The ZanyArtifacts PaperMC plugin requires PaperMC 1.21.11 or newer (not 1.21.4).
```
...
<!-- <rawResChunk><answer>@Scyye, here's the updated `README.md` with the corrected version requirement and a table of contents:
